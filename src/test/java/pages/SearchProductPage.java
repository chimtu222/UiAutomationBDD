...
public SearchProductPage(WebDriver driver){
    ...
    /*-----------------------------------Methods---------------------------------------*/
	     ...
	     public void passingInValidInput(String searchString) {
	     try{
	     ...
	     Hooks.test.log(Status.PASS,"Search Element Passed to search Bar");
	     }catch(Exception e){
	    	 	String Path=ReporterMaker.captureScreenShot("FailedValuePass");
	    	 	Hooks.test.addScreenCaptureFromPath(Path, "FailedValuePass");
	     ...
	     public void verifyingResultPage() {
	     try{
	     ...
	     helper.softAssertContaing(actualWarning,expectedWarning);
	     Hooks.test.log(Status.PASS,"Warning for Invalid Product Text Found");
	     ...
	     Hooks.test.addScreenCaptureFromPath(Path, "SuccessInvalidProductWarningText");
	     }catch(Exception e){
	             ...
	             Hooks.test.addScreenCaptureFromPath(Path, "FailedInvalidProductWarningText");
	             LoggerGeneretor.error("Warning text For Invalid Product Not Found...");
	             Hooks.test.log(Status.FAIL,"Warning text For Invalid Product Not Found...");
	      }
	}
	
	     /*------------------Passing Valid input To SearchBar---------------*/
	     public void passingValidInputToSearchBar(String searchString) {
		     try{
		     helper.sendKeys(HomePageUi.searchBar, searchString);
		     WebElement Text=driver.findElement(HomePageUi.searchBar);
		     String actualText=Text.getText();
		 ...
		 public void passingSubStringValue(String searchString) {
		     try{
		     helper.sendKeys(HomePageUi.searchBar, searchString);
		     WebElement Text=driver.findElement(HomePageUi.searchBar);
		     String actualText=Text.getText();
		 ...
		 public void clickingOnSmartPhone() {
		     try{
			     ...
			     helper.softAsserting(actualText, expectedText);
			     Hooks.test.log(Status.PASS,"Clicked Smart Phone");
			     ...
			     helper.switchToNewWindow();
			    	     ...
			    	     Hooks.test.addScreenCaptureFromPath(Path, "FailedSmartPhone");
			             LoggerGeneretor.error("Failed to Click Smart Phone...");
			             Hooks.test.log(Status.FAIL,"Failed to Click Smart Phone...");
			     }
		     }
		     
		 /*------------------Clicking On First Product Link---------------*/
		 public void clickingOnFirstProductCard() {
		 ...
		 public void clickingOnContactSupplier() {
		     try{
			     helper.clickOnElement(SearchResultPageUi.contactSplr);
			     Hooks.test.log(Status.PASS,"Clicked Contact Supplier");
			     ...
			     helper.switchToNewWindow();
			    	     ...
			    	     Hooks.test.addScreenCaptureFromPath(Path, "FailedContactSupplierClick");
			             LoggerGeneretor.error("Failed to Click Contact Supplier...");
			             Hooks.test.log(Status.FAIL,"Failed to Click Contact Supplier...");
			     }
		     }
		 
		 /*------------------Verifying Result Page---------------*/
		 public void verifyingResultPageAfterClicking() {
		     ...
		     try{
			     ...
			     helper.softAsserting(actualText, expectedText);
			     Hooks.test.log(Status.PASS,"Send Inquiry Found in Contact Supplier Page");
			     ...
			     Hooks.test.addScreenCaptureFromPath(Path, "SuccessContactSplr");
			     }catch(Exception e){
			             ...
			             Hooks.test.addScreenCaptureFromPath(Path, "FailedContactSupplierPage");
			             LoggerGeneretor.error("Contact Supplier Page Not Found...");
			             Hooks.test.log(Status.FAIL,"Contact Supplier Page Not Found...");
			   }
	  }
